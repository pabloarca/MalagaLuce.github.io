    ...
    map.on('click', 'action-points', e => {
      let properties = e['features'][0]['properties'],
          ...
          emblem_path = properties['volunteers'].split(',')
            ...
            .split(':')[1].slice(1,-1),
          volunteers_group = properties['volunteers']
          ...
          html = `
            ...
            ${properties['finishedPic'] ? '<a href=' + properties['finishedPic'] + ' target="_blank"><figure><img class="popup__pic" src=' + properties['finishedPic'] + '><figcaption>Despues</figcaption></figure></a>' : ''}
            </div>
